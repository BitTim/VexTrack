...
namespace VexTrack.Core
{
	...
	public class GoalEntryData
	{
		...
		public GoalEntryData(string uuid, string groupUUID, string depUUID, string title, double progress, int collected, int remaining, int total, string color, string completionStatus, string activityStatus, bool paused, int position = -1, int startXP = -1, int active = -1)
		{
			UUID = uuid;
			GroupUUID = groupUUID;
			DepUUID = depUUID;
	...
	public class GoalGroupData
	{
		...
		public GoalGroupData(string uuid, string name, List<GoalEntryData> goals, int position = -1)
		{
			UUID = uuid;
			Name = name;
			Goals = goals;
